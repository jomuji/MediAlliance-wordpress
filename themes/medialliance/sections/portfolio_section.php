	...
	<section id="<?php echo $post->post_name; ?>" class="content" style="background-color:#FFF">
		...
		<div class="container portfolio-title">
            ...
            <div class="section-title">
                ...
                <p class="the-content"><?php echo get_post_meta(get_the_ID(), 'newave_page_subtitle', true); ?></p>
            </div>				
			<!--/Section Title -->
            <?php } ?>
  ...
  (function($) {    
    $(document).ready(function() {  
     var offclick = $("#portfolio-wrap").children(".portfolio-item");
     var leclic= $(".noclick a")
     //var direction = $("#portfolio-wrap a");

              if (offclick.hasClass("noclick")) {
                    leclic.remove();                    
                }           
      }); 
  })(jQuery);
